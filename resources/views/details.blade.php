    ...
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            <div class="md:ml-24">
                ...
                <div class="mt-12">
                    ...
                    <div class="flex mt-4">
                        @foreach($movie['credits']['crew'] as $crew)
                            @if($crew['job'] == 'Screenplay' || $crew['job'] == 'Director')
                                <div class="mr-8">
                                    <div>{{$crew['name']}}</div>
                ...
                <div class="mt-12">
                    <a href="https://www.youtube.com/watch?v={{ $movie['videos']['results'][0]['key'] }}" target="_blank" class="flex inline-flex items-center bg-orange-500 text-gray-900 rounded font-semibold px-5 py-4 hover:bg-orange-600 transition ease-in-out duration-150 cursor-pointer">
